...
emc = pd.read_csv('comparison/filteredEMCData.csv')#, skiprows=[0])#, skiprows=range(1, 300))# nrows=50)
...
for id_num in range(1, 17):
    pltdata, lastPoint, x_data, y_data, z_data = plot_positional_data(id_num)
